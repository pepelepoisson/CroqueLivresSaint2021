...
void displayDashboard(GxEPD2_GFX& display, int code_run_counter, int current_citation, int number_of_citations, float batteryVoltage){
  ...
  do
  {
    ...
    display.println(String(current_citation%number_of_citations));
...
void setup()
{
  ...
  // If citations.txt file exists read it to update number of citations counter
  if (citations_file_exists){
